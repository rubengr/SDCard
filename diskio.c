...
sd_tx(d)	{unsigned char data[2];data[0] = d; wiringPiSPIDataRW(SPI_CHANNEL, &data, 1);}
sd_rx()		{unsigned char data[2];data[0] = 0xFF; wiringPiSPIDataRW(SPI_CHANNEL, &data, 1);return data[0];}
